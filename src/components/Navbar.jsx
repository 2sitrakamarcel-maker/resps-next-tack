...
const Navbar = ({ activeTab, onSelectTab, selectedDay }) => {
  const tabs = ['Home', 'Stats', 'Plan', 'Params']
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`px-4 sm:px-6 py-2 rounded-full font-bold text-xs sm:text-sm whitespace-nowrap shrink-0 min-h-[36px] sm:min-h-0 transition-all duration-300 ${
                isActive
